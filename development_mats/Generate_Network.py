...
#Then get that data
ChR2_raw_data, ChR2_nodes = loadData('/Users/kedorst/Desktop/csv_files/ChR2_SB/ChR2_Small_Box.csv')
Control_raw_data, Control_nodes = loadData('/Users/kedorst/Desktop/csv_files/Control_SB/Control_Small_Box.csv')
...
ChR2_DG_subgraph = DG_subgraph(ChR2_markov_clusters, ChR2_nodes, ChR2_graph, ChR2_pos_dict, allen_color_list)
Control_DG_subgraph = DG_subgraph(Control_markov_clusters, Control_nodes, Control_graph, Control_pos_dict, allen_color_list)
